...
public class User {
    ...
    public void save(PrintWriter printWriter){
        ...
        printWriter.println(String.valueOf(birthDate.getTime()));
    ...
    public void load(BufferedReader reader) throws IOException {
           ...
           this.lastName = reader.readLine();
            ...
            this.isMale =Boolean.parseBoolean(reader.readLine());
            this.country = Country.valueOf(reader.readLine().toUpperCase());
    }
