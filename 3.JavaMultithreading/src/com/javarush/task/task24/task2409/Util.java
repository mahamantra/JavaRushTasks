    ...
    public static List<Jeans> getAllJeans() {
         abstract class AbstractJeans implements Jeans{
            ...
            public String toString() {
                return this.getTM()+"{id="+id+", length="+length+", size="+size+", price="+price+"}";
            }
        }
         class Levis extends AbstractJeans {
            ...
            public Levis(int length, int id, int size, double price) {
                super(length, id, size, price);
            }
        }
         ...
         class Denim extends AbstractJeans {
            ...
            public Denim(int length, int id, int size, double price) {
                super(length, id, size, price);
            }
        }
        //add your code here
